...
def unet_3d(input_size=(64, 64, 64, 1)):
    ...
    input_size does not contain the batch size. The default input,
    for example, indicates that the model expects images with 64 planes, 64
    rows, 64 columns, and one channel.
    ...
    conv_down_4 = layers.Conv3D(filters=512,
                                ...
                                kernel_initializer='he_normal')(conv_down_4)
    dropout_4 = layers.Dropout(0.5)(conv_down_4)
    max_pool_4 = layers.MaxPooling3D(pool_size=(2, 2, 2))(dropout_4)

    # level 5 - down
    conv_down_5 = layers.Conv3D(filters=1024,
                                kernel_size=3,
                                activation='relu',
                                padding='same',
                                kernel_initializer='he_normal')(max_pool_4)
    ...
    # level 4 - up
    conv_up_4 = layers.Conv3D(filters=512,
                              kernel_size=2,
                              activation='relu',
                              padding='same',
                              kernel_initializer='he_normal')(
                                  layers.UpSampling3D(size=(2, 2, 2))(dropout_5)
                              )
    merge_4 = layers.concatenate([dropout_4, conv_up_4], axis=-1)
    conv_up_4 = layers.Conv3D(filters=512,
                              kernel_size=3,
    ...
    conv_up_3 = layers.Conv3D(filters=256,
                              ...
                              padding='same',
                              kernel_initializer='he_normal')(
                                  layers.UpSampling3D(size=(2, 2, 2))(conv_up_4)
                              )
    merge_3 = layers.concatenate([conv_down_3, conv_up_3], axis=-1)
    conv_up_3 = layers.Conv3D(filters=256,
                              kernel_size=3,
    ...
    conv_up_2 = layers.Conv3D(filters=128,
                              ...
                              padding='same',
                              kernel_initializer='he_normal')(
                                  layers.UpSampling3D(size=(2, 2, 2))(conv_up_3)
                              )
    merge_2 = layers.concatenate([conv_down_2, conv_up_2], axis=-1)
    conv_up_2 = layers.Conv3D(filters=128,
                              kernel_size=3,
    ...
    conv_up_1 = layers.Conv3D(filters=64,
                              ...
                              padding='same',
                              kernel_initializer='he_normal')(
                                  layers.UpSampling3D(size=(2, 2, 2))(conv_up_2)
                              )
    merge_1 = layers.concatenate([conv_down_1, conv_up_1], axis=-1)
    conv_up_1 = layers.Conv3D(filters=64,
                              kernel_size=3,
